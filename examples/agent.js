...
if (!token) {
  process.stderr.write('RESOURCE_TOKEN is not set; configure caracal run with CARACAL_RUN_CREDENTIALS_FILE, then run `pnpm caracal run -- node examples/agent.js`.\n')
  process.exitCode = 1
} else {
