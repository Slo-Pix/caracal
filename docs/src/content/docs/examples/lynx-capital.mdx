...
Start Caracal with the released runtime and Console, then use Console to enable Control, create the Lynx zone, create a control key, and register provider resources.
