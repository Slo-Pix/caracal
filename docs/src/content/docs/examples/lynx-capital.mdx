...
description: A FastAPI and LangGraph multi-agent swarm that processes a weekly invoice batch across 5 regions through 14 financial provider integrations — demonstrating Caracal's delegation, ephemeral agent, and multi-protocol transport patterns.
pageType: workflow
---
