...
| Domain | Tables |
| --- | --- |
| Product model | `zones`, `providers`, `applications`, `resources`, `application_dependencies`, `teams` |
| Authority | `sessions`, `delegated_grants`, `grants`, `invitations`, `step_up_challenges` |
