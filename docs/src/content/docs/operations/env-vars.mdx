...
| `METRICS_BEARER` / `METRICS_BEARER_FILE` | optional | STS, Gateway, API, Audit, Coordinator | Metrics endpoint bearer token. In published mode (`rc`/`stable`) the metrics endpoints fail closed (401) until this is set. |
