...
| Teams | `GET`, `POST /v1/zones/:zoneId/teams` | `GET`, `PATCH`, `DELETE /v1/zones/:zoneId/teams/:id` | — |
...
| Invitations | `GET /v1/zones/:zoneId/invitations` | `POST /v1/zones/:zoneId/invitations`, `DELETE /v1/zones/:zoneId/invitations/:id` |
