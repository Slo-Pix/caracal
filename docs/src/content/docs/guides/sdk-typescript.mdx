...
`bindFromHeaders()` and `caracal.middleware()` do not verify JWT signatures, audience, scopes, token use, or revocation. Use [`@caracalai/mcp-express`](../protect-express/) for direct Express protection, or keep the service behind Gateway.
