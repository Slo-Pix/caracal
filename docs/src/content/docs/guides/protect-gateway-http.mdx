...
Open the web console **Audit** and **Request Traces** with the request ID. A complete Gateway-routed call has both authorization evidence from STS and action-result evidence from Gateway.
