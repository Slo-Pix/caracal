...
Find the request ID from the SDK error, STS response, Gateway response, web console audit event, or application log. Open web console **Request Traces** and paste it.
