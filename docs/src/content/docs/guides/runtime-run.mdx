...
4. Fill in the external upstream URL, resource identifier, runtime profile, profile path, secret file, and first request path.
...
| Audit captured the request | Console `audit` or `explain`. |
