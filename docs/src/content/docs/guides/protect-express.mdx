...
```bash
npm install express @caracalai/mcp-express @caracalai/revocation
```
...
The middleware attaches verified claims to `req.caracalClaims` and the propagation context to `req.caracalContext`.
