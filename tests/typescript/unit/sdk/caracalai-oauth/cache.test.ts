...
//
// InProcessTokenCache unit tests.

import { describe, it, expect, beforeEach, vi } from 'vitest'
import { InProcessTokenCache } from '../../../../../packages/caracalai-oauth/src/cache.js'
import type { TokenExchangeResponse } from '../../../../../packages/caracalai-oauth/src/types.js'
...
describe('InProcessTokenCache', () => {
  let cache: InProcessTokenCache

  beforeEach(() => {
    cache = new InProcessTokenCache()
  })
