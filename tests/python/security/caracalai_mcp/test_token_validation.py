...
#
# Python MCP middleware security tests for token misuse rejection.
...
class TokenValidationSecurityTests(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_rejects_missing_zone_claim(self) -> None:
        ...
        with self.assertRaises(ValueError):
            await middleware.verify_token(token, "https://sts.example.com", "resource://api")
