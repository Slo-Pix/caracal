...
Use when reviewing or implementing Caracal SDK setup that involves secrets, tokens, API keys, client secrets, private keys, provider credentials, or environment variables.
